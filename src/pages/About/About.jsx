...
export const About = () => {
  const data = [
    "My name is Jessica and I am based in Täby. My passion for web development began in 2011 when I worked at a streaming company and had the opportunity to collaborate closely with programmers. This sparked my interest in the industry and motivated me to pursue my dream of becoming a developer.",
